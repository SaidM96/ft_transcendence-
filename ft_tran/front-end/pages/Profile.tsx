...
const Profile = ({tocken})=>{
    ...
    return (
        ...
        <div className=" parent   grid grid-cols-6 px-10 min-w-[50vh]     max-w-[1324px]  max-h-full">
            ...
            <div className="bg-gradient-to-r from-green-400 to-blue-500 shadow-2xl inh col-span-4  m-2 rounded-2xl grid grid-cols-2 grid-rows-2 h-26">
