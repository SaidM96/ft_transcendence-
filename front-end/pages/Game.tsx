...
export default function Game() {
  ...
  //   const MatterNode = new MatterJsModules(roomId, context?.socket)
  ...
  }, [context?.socket]); // Empty dependency array to run the effect only once
  ...
  return (
    <>
      ...
      <main>
        ...
        {isModalOpen && <ModalGame isOpen={isModalOpen} closeModal={closeModal} title="ldkfj" msg={winner} color='bg-white' />}
